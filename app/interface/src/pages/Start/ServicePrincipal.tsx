    ...
    <div className="flex flex-col items-center space-y-6">
      <div className="flex flex-col space-y-6">
        <p className="text-2xl text-slate-500">
          Terraform uses some Microsoft Graph APIs which can't be accessed with
          a user principal from a docker container due to orgnization policy
        ...
        <p className="text-2xl text-slate-500">
          <strong>NOTE:</strong> If you've configured this before, you dont have
          to do it again unless validation failed.
        </p>
      </div>
