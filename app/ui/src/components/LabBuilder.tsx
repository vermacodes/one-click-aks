...
import { LabType, TfvarConfigType } from "../dataStructures";
...
export default function LabBuilderM({ showLabBuilder, setShowLabBuilder, tfvarConfig }: LabBuilderPropsType) {
    ...
    function handleSubmit() {
        ...
        axiosInstance.post("createlab", lab).then((response) => {
                ...
                <Form>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control
                            as="textarea"
                            rows={5}
                            value={JSON.stringify(lab.tfvar, null, 4)}
                            readOnly
                        ></Form.Control>
                    </Form.Group>
                    <Form.Group>
                        ...
                        <Form.Control
                            as="textarea"
                            rows={5}
                            onChange={(e) => handleBreakScriptChange(e.target.value)}
                        ></Form.Control>
                    </Form.Group>
                    <Form.Group>
                        ...
                        <Form.Control
                            as="textarea"
                            rows={5}
                            onChange={(e) => handleValidateScriptChange(e.target.value)}
                        ></Form.Control>
                    </Form.Group>
                </Form>
            </Modal.Body>
